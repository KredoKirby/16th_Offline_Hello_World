...
class CourseSeeder extends Seeder
{
    ...
    //    php
        ...
        $phpIntro = Topic::create(['course_id' => $php->id, 'title' => 'PHP入門' ]);
        Lesson::create([
            'course_id'   => $php->id,
        ...
        $phpSyntax = Topic::create(['course_id' => $php->id, 'title' => '基礎文法']);
        Lesson::create([
            'course_id'   => $php->id,
        ...
        $phpPrac = Topic::create(['course_id' => $php->id, 'title' => '実践']);
        Lesson::create([
            'course_id'   => $php->id,
            'topic_id'  => $phpPrac->id,
            'title'       => 'フォーム処理',
        ...
        $jsIntro = Topic::create(['course_id' => $js->id, 'title' => 'JavaScript入門']);
        Lesson::create([
            'course_id'   => $js->id,
            'topic_id'  => $jsIntro->id,
            'title'       => 'JavaScriptとは？',
        ...
        $enBasicSec1 = Topic::create(['course_id' => $enBasic->id, 'title' => 'Greetings']);
        Lesson::create([
        ...
        $pyIntro = Topic::create(['course_id' => $py->id, 'title' => 'Python入門']);
        Lesson::create([
            'course_id'   => $py->id,
            'topic_id'    => $pyIntro->id,
            'title'       => 'Pythonとは？',
        ...
        $pySyntax = Topic::create(['course_id' => $py->id, 'title' => '基礎文法']);
        Lesson::create([
            'course_id'   => $py->id,
        ...
        $pyData = Topic::create(['course_id' => $py->id, 'title' => 'データ処理']);
        Lesson::create([
            'course_id'   => $py->id,
            'topic_id'    => $pyData->id,
            'title'       => 'リストと辞書',
