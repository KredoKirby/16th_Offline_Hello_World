    ...
    <div class="card-body">
      ...
      <form method="POST" action="{{ route('admin.courses.store') }}" enctype="multipart/form-data">
        ...
        <div class="mb-3">
          ...
          <input type="number" step="0.01" name="price" value="{{ old('price', 5000) }}" class="form-control">
        </div>
        ...
        <div class="d-flex justify-content-between">
          ...
          <button class="btn btn-dark" type="submit" style="background-color:#9CDBE2;  border:white">Save</button>
        </div>
      </form>
    </div>
  </div>
